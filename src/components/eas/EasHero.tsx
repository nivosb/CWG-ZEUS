      ...
      <div className="max-w-5xl mx-auto">
        <div className="space-y-6">
          <div className="inline-flex items-center px-4 py-1.5 bg-white/5 rounded-full backdrop-blur-sm">
            <Radar className="w-4 h-4 text-[#9C27DF] mr-2" />
            <span className="text-white/80 text-sm">Managed External Attack Surface</span>
          </div>
          ...
          <p className="text-xl text-gray-400 max-w-3xl">
            Comprehensive visibility and protection of your external attack surface through continuous monitoring, vulnerability assessment, and proactive threat mitigation.
          </p>
