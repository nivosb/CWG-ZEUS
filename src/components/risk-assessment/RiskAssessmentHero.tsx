...
const RiskAssessmentHero: React.FC = () => {
      ...
      <div className="max-w-5xl mx-auto">
        <div className="space-y-6">
          <div className="inline-flex items-center px-4 py-1.5 bg-white/5 rounded-full backdrop-blur-sm">
            <FileSearch className="w-4 h-4 text-[#9C27DF] mr-2" />
            <span className="text-white/80 text-sm">Security Risk Assessment</span>
          </div>
          ...
          <p className="text-xl text-gray-400 max-w-3xl">
            Identify, analyze, and mitigate security risks across your organization with our expert assessment services aligned with industry standards.
          </p>
