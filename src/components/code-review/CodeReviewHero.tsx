      ...
      <div className="max-w-5xl mx-auto">
        <div className="space-y-6">
          <div className="inline-flex items-center px-4 py-1.5 bg-white/5 rounded-full backdrop-blur-sm">
            ...
            <span className="text-white/80 text-sm">Code Review Services</span>
          </div>
          ...
          <p className="text-xl text-gray-400 max-w-3xl">
            Comprehensive code analysis to identify security vulnerabilities, logic flaws, and potential improvements in your applications.
          </p>
