      ...
      <div className="max-w-5xl mx-auto">
        <div className="space-y-6">
          <div className="inline-flex items-center px-4 py-1.5 bg-white/5 rounded-full backdrop-blur-sm">
            <AlertCircle className="w-4 h-4 text-[#9C27DF] mr-2" />
            <span className="text-white/80 text-sm">24/7 Incident Response</span>
          </div>
          ...
          <p className="text-xl text-gray-400 max-w-3xl">
            Expert incident response team available 24/7 with guaranteed SLA to help your organization respond to and recover from cyber incidents quickly and effectively.
          </p>
...
export default IncidentResponseHero;