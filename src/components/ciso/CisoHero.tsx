      ...
      <div className="max-w-5xl mx-auto">
        <div className="space-y-6">
          <div className="inline-flex items-center px-4 py-1.5 bg-white/5 rounded-full backdrop-blur-sm">
            ...
            <span className="text-white/80 text-sm">CISO as a Service</span>
          </div>
          ...
          <p className="text-xl text-gray-400 max-w-3xl">
            Get enterprise-grade security leadership and expertise without the overhead of a full-time executive hire. Our CISO as a Service offering provides strategic guidance, compliance management, and security program development.
          </p>
